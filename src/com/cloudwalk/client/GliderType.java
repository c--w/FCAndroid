...
/**
 * This class implements the reading and writing of data files for different
 * types of glider. A glider's data file determines its flying characteristics
 * and its 3d representation.
 * 
 * Currently we have three types of glider. The relevant data files -
 * hangglider.txt, paraglider.txt, sailplane.txt - may be found in the folder
 * ~/xc/class/. The file format is as follows:
 * 
 * <pre>
 * 
 *    # hangglider
 ...
 * </pre>
 * 
 * Note the polar has a trailing comma after the last pair of speed and sink
 * values. The text after OBJ3D: is the 3d representation of the glider. This
 * portion of the file will be parsed by Obj3d.
 */
public class GliderType {
	...
	protected List<float[]> polar;
	protected float turnRadius;

	/**
	 * Creates an instance of <code>typeName</code> or throws an IO error. Opens
	 * the relevant data file, parses it and sets my properties accordingly.
	 * This is the constructor used by the client.
	 */
	...
	/**
	 * Creates an empty instance of glider type ready for you to specify its
	 * properties. Use this constructor if you are running glider type stand
	 * alone in order to *write* a def file.
	 * 
	...
	public String toString() {
		...
		for (int i = 0; i < polar.size(); i++) {
			sb.append(Tools3d.round(polar.get(i)[0]) + " " + Tools3d.round(polar.get(i)[1]) + " , ");
		}
		sb.append("\n");
